...
public class ProjectRepositoryTest extends BasicRepositoryTest {
    ...
    public void createTest() {
        assertEquals(0, projectRepository.getAll().size());
        projectRepository.create(Project.builder().name("asd").build());
    ...
    public void readTest() {
        final Long generatedKey = projectRepository.create(PROJECT);
        final Project project = projectRepository.getById(generatedKey);
    ...
    public void deleteTest() {
        final Long generatedKey = projectRepository.create(PROJECT);
        projectRepository.delete(generatedKey);
        final Project project = projectRepository.getById(generatedKey);
        assertNull(project);
    }
